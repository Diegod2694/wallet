...
export default class ShockAvatar extends React.PureComponent {
  ...
  render() {
    const { height, image, lastSeenApp, onPress } = this.props
    return (
      <Avatar
        height={height}
        rounded
        ...
        onPress={onPress}
        // @ts-ignore
        avatarStyle={isOnline(lastSeenApp) ? styles.avatar : CSS.styles.empty}
      />
    )
  }
}
 ...
 */
// @ts-ignore TODO
const _ConnectedShockAvatar = connect(mapStateToProps)(ShockAvatar)
